...
var StoryService_1 = __importDefault(require("../services/StoryService"));
var router = express_1.default.Router();
router.get('/:storyID', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var storyService, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, StoryService_1.default.fetchPageByID(req.params.storyID)];
            case 1:
                storyService = _a.sent();
                res.status(200);
                res.json({
